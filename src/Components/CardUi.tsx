...
export default function CardUI(){
    ...
    if(!isMobile){
        ...
        return(
              ...
              //  {/* main-container */}
                <div className="bg-zinc-900  w-full flex flex-col items-center rounded-xl mx-3 px-2" style={{height:'20vh' }}>
        ...
        return(
                                  ...
                                  //  {/* main-container */}
                <div className="bg-zinc-900  w-full flex flex-col items-center rounded-xl  px-2" style={{height:'70vh' }}>
